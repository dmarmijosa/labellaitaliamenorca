    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.form}>
                ...
                <CustomTextInput image={require('../../../../assets/confirm_password.png')}
